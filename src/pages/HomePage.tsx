...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-black dark:via-black dark:to-black relative overflow-hidden transition-colors duration-300">
      {/* Decorative Background Elements */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-400/20 to-purple-400/20 dark:from-blue-600/20 dark:to-purple-600/20 rounded-full blur-3xl -z-10 animate-pulse" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-purple-400/20 to-pink-400/20 dark:from-purple-600/20 dark:to-pink-600/20 rounded-full blur-3xl -z-10 animate-pulse" style={{ animationDelay: '1s' }} />
      {/* Navigation */}
      <nav className={`border-b border-white/20 dark:border-white/10 bg-white/70 dark:bg-black/80 backdrop-blur-md fixed top-0 left-0 right-0 z-50 shadow-lg shadow-black/5 transition-all duration-300 ${
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <Button
                ...
                size="icon"
                onClick={toggleTheme}
                className="h-9 w-9 rounded-full hover:bg-gray-200/50 dark:hover:bg-gray-700/50"
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/30 dark:from-black dark:via-black dark:to-black">
        {/* Background Decorative Elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 -left-20 w-72 h-72 bg-blue-400/10 dark:bg-blue-500/15 rounded-full blur-3xl"></div>
          <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-purple-400/10 dark:bg-purple-500/15 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-blue-400/5 to-purple-400/5 dark:from-blue-500/10 dark:to-purple-500/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-20 relative">
          <div className="text-center max-w-5xl mx-auto">
            ...
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm mb-6 sm:mb-8 animate-fade-in animation-delay-200">
              <Sparkles className="h-4 w-4 text-blue-600 dark:text-blue-400" />
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Free Professional Resume Builder</span>
            </div>
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6 sm:mb-8 animate-fade-in-up animation-delay-400 px-4">
              <span className="text-gray-900 dark:text-white">Build Your Perfect</span>
              <br />
              <span className="text-gray-900 dark:text-white">Resume in </span>
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 sm:mb-12 leading-relaxed animate-fade-in-up animation-delay-600 px-4 max-w-3xl mx-auto font-light">
            ...
            <div className="mb-12 sm:mb-16 animate-fade-in animation-delay-600">
              <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-10 px-4">
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-blue-600 dark:text-blue-400 mb-1 tabular-nums">
                    {resumeCount.toLocaleString()}+
                  </div>
                  <div className="text-sm sm:text-base text-gray-600 dark:text-gray-400 font-medium">Resumes Created</div>
                </div>
                
                <div className="hidden sm:block w-px h-12 bg-gray-300 dark:bg-gray-700"></div>
                
                <div className="text-center">
                  <div className="text-3xl sm:text-4xl font-bold text-green-600 dark:text-green-400 mb-1 tabular-nums">
                    {templateCount}
                  </div>
                  <div className="text-sm sm:text-base text-gray-600 dark:text-gray-400 font-medium">Premium Templates</div>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 max-w-4xl mx-auto animate-fade-in animation-delay-600 px-4">
              <div className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg transition-all">
              ...
              <div className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg transition-all">
                ...
                <div className="text-center">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-1">ATS Optimized</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Beat the bots</p>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center gap-3 p-6 rounded-2xl bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 hover:shadow-lg transition-all">
                ...
                <div className="text-center">
                  <h3 className="font-semibold text-gray-900 dark:text-white mb-1">Instant PDF</h3>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Download ready</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Grid */}
      <section className="container mx-auto px-4 sm:px-6 py-16 sm:py-24 relative bg-white dark:bg-black">
        <div className="text-center mb-12 sm:mb-20">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6 text-gray-900 dark:text-white">Everything You Need to Succeed</h2>
          <p className="text-base sm:text-xl text-gray-600 dark:text-gray-400 px-4 max-w-2xl mx-auto">
      ...
      {/* Testimonials */}
      <section className="bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-950 dark:to-black py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-20">
            <div className="inline-block px-4 py-1.5 rounded-full bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-sm font-medium mb-4">
              Testimonials
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4 sm:mb-6 text-gray-900 dark:text-white">Loved by Job Seekers</h2>
            <p className="text-base sm:text-xl text-gray-600 dark:text-gray-400 px-4 max-w-2xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {[
            ...
            <Card key={i} className="border-0 bg-white dark:bg-gray-900 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardHeader>
                ...
                <CardDescription className="text-base leading-relaxed text-gray-700 dark:text-gray-300 font-medium">
                  "{testimonial.content}"
                </CardDescription>
              </CardHeader>
              <CardContent>
